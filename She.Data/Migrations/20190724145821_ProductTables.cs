    ...
    public partial class ProductTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AvailableColors", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AvailableSizeId = table.Column<int>(nullable: false),
                    ProductId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductSizes", x => new { x.ProductId, x.AvailableSizeId });
                    table.ForeignKey(
                        name: "FK_ProductSizes_AvailableSizes_AvailableSizeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSizes_AvailableSizeId",
                table: "ProductSizes",
